...
namespace AppointmentMaker.Controllers
{
    ...
    public class AppointmentController : Controller
    {
        ...
        public AppointmentController(IAppointmentService service)
            => _service = service; //Inject the reel database instance
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            var appointmentDetail = await _service.GetById(id);
        ...
        {
            //If data validation is not valid , for example invalid properties on create.cshtml form.
        ...
        {
            //Get record by the provided Id, assign the record to variable appointment.
            var appointment = await _service.GetById(id);

            if (appointment == null) // Check if record not exit
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int id,AppointmentModel model)
        {
